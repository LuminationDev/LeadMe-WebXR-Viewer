...
const generateInnerHTML = (cssPrefix, height)=> {
    ...
    return `<div id="webxr-button" class="${cssPrefix}-button">
...
export class WebXRConnectionIndicator {
    /**
    ...
    constructor(options) {
        ...
        options.textEnterXRTitle = options.textEnterXRTitle || 'Connected. Launching your experience!';
        options.textXRNotFoundTitle = options.textXRNotFoundTitle || 'Awaiting headset connection...';
    ...
    __updateButtonState() {
        if (this.session) {
            ...
            this.setTooltip('Connected. Launching your experience!');
            this.__setDisabledAttribute(false);
        } else {
            this.setTitle(this.options.textXRNotFoundTitle);
            this.setTooltip('Awaiting headset connection...');
            this.__setDisabledAttribute(true);
        }
    }
}
